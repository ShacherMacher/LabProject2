...
<div class="container">
    ...
    <option value="2">User</option>
      ...
      <input type="file" name="picture" required="required">
       Password: <input type="password" id="psw" name="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" 
       title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters" required="required"><br>
